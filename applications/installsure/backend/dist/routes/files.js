...
router.post('/upload', upload.single('file'), async (req, res) => {
    try {
        ...
        const result = await db.query('INSERT INTO files (filename, original_name, file_path, file_size, file_type) VALUES ($1, $2, $3, $4, $5) RETURNING *', [filename, originalname, filePath, size, fileType]);
