        ...
        <div className="space-y-4">
          ...
          {takeoffData && (
            <div className="border rounded-lg p-4">
              <h4 className="font-medium text-gray-900 mb-2">Takeoff Results</h4>
              <div className="space-y-2">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <span className="text-sm font-medium text-gray-500">Areas:</span>
                    <span className="ml-2 text-sm text-gray-900">
                      {takeoffData.areas?.length || 0}
                    </span>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-gray-500">Lengths:</span>
                    <span className="ml-2 text-sm text-gray-900">
                      {takeoffData.lengths?.length || 0}
                    </span>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-gray-500">Volumes:</span>
                    <span className="ml-2 text-sm text-gray-900">
                      {takeoffData.volumes?.length || 0}
                    </span>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-gray-500">Counts:</span>
                    <span className="ml-2 text-sm text-gray-900">
                ...
                <div className="mt-4">
                  <h5 className="text-sm font-medium text-gray-700 mb-2">Raw Data:</h5>
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="border rounded-lg p-4 hover:bg-gray-50 cursor-pointer">
            ...
            <p className="text-sm text-gray-600 mt-1">Generate detailed quantity reports</p>
          </div>
          <div className="border rounded-lg p-4 hover:bg-gray-50 cursor-pointer">
            <h4 className="font-medium text-gray-900">Cost Estimation</h4>
            <p className="text-sm text-gray-600 mt-1">Calculate project costs from quantities</p>
          </div>
          <div className="border rounded-lg p-4 hover:bg-gray-50 cursor-pointer">
            <h4 className="font-medium text-gray-900">Progress Report</h4>
            <p className="text-sm text-gray-600 mt-1">Track project progress and milestones</p>
          </div>
        </div>
      </div>
    </div>
